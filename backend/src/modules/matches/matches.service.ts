...
// "Iniciar partida" marca como presentes (attended) todos os jogadores que estão
// escalados nos times, liberando o placar ao vivo sem precisar de um checkin manual prévio.
...
// Recalcula overall/atributos de todos os jogadores que participaram do jogo, com base
// nos gols/assistências/votos ATUAIS. Usado tanto ao fechar o jogo quanto ao recalcular
// depois de uma correção manual de estatística num jogo já fechado.
